...
st.sidebar.image('https://th.bing.com/th/id/OIP.1FrQkfZYNq_ee1zC64nQPAAAAA?rs=1&pid=ImgDetMain')
...
if user_menu == 'Overall Analysis':
    ...
    st.title("Participation Graph through the years")
    st.plotly_chart(fig)
...
if user_menu == "Athlete wise Analysis":
    # Remove duplicate athletes based on 'Name' and 'region'
    athlete_df = df.drop_duplicates(subset=['Name', 'region'])

    # Drop missing values and extract ages for different medal categories
